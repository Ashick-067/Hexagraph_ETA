...
def add_concepts_and_links(
        ...
        output_hg_id = generate_hg_id(output_id)
        ...
        return target_output_join_list

def output_mesh_terms_process_row(row):
    output_mesh_terms_data_from_row = []
    return add_concepts_and_links(
        safe_get_column(row, 'id'),
        None,
